...
export default function Subscription() {
  ...
  return (
    <section className="bg-gray-50 border-t border-gray-200 py-20 px-6 text-center">
      <h2 className="text-3xl md:text-4xl font-bold text-zinc-900 mb-4 drop-shadow">
        Pick the Perfect Plan for Your AI Journey
      </h2>
      <p className="text-gray-600 max-w-xl mx-auto mb-8">
        OrionAI offers flexible plans for students, professionals and teams to
      ...
      <div className="flex justify-center items-center mb-12 gap-4">
        ...
        >
          <div
            className={`w-6 h-6 bg-zinc-900 rounded-full absolute top-0 transition-all ${
        ...
        >
          Yearly <span className="text-zinc-800">- Up To 50% OFF</span>
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {/* Basic Plan */}
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-8 hover:shadow-md hover:border-gray-300 transition">
          <h3 className="text-2xl font-semibold text-zinc-900 mb-4">
            Basic Plan
          </h3>
          <p className="text-4xl font-bold text-zinc-900 mb-2">
        ...
        {/* Pro Plan */}
        <div className="bg-zinc-900 text-white rounded-2xl shadow-sm p-8 hover:shadow-md border border-zinc-800 transition">
          <h3 className="text-2xl font-semibold mb-4">Pro Plan</h3>
          <p className="text-4xl font-bold mb-2">
            ₹{getDisplayPrice("pro")}
          </p>
          <p className="text-sm mb-6 text-gray-300">For growing companies</p>
